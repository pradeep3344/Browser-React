...
const AddIconItemIcon5 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 42 42' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    <path
      fillRule='evenodd'
      clipRule='evenodd'
      d='M26.7069 22.4005H21.1225V27.985H19.4042V22.4005H13.8198V20.6823H19.4042V15.0979H21.1225V20.6823H26.7069V22.4005Z'
      fill='white'
      stroke='white'
    />
    <path
      ...
      fill='#40D589'
    />
    <rect x={13} y={20} width={15} height={3} fill='white' />
  </svg>
);

const Memo = memo(AddIconItemIcon5);
export { Memo as AddIconItemIcon5 };
